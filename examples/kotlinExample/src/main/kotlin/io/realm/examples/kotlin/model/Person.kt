...
public open class Person(
        ...
        // Annotations must be prefixed with @field: in order be placed on the
        // underlying field declaration like in Java.
        // See https://kotlinlang.org/docs/reference/annotations.html#annotation-use-site-targets
        @field:PrimaryKey public open var name: String = "",
        ...
        @field:Ignore public open var tempReference: Int = 0,
